        ...
        if (msg.type === 'SET_LOCATION') {
          ...
          const descriptionHTML = p.description
            ? '<div style="' +
                ...
                'font-style: italic;' +
              '">"' + p.description + '"</div>'
            : '<div style="color:#888;font-size:12px;font-style:italic">No description</div>';
          ...
          const colors = { medical: '#ff4444', rescue: '#4444ff', fire: '#ff8800', flood: '#00bbbb' };
          const color = colors[p.type.toLowerCase()] || '#00ff41';
          ...
          // Open popup permanently by default
          marker.openPopup();
